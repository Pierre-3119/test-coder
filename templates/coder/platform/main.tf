...
resource "coder_app" "pgadmin-app" {
  agent_id     = coder_agent.main.id
  slug         = "pgadmin-app"
  display_name = "pgAdmin"
  icon         = "${data.coder_workspace.me.access_url}/icon/postgres.svg"
  url          = "http://localhost:8888"
  tooltip      = "pgAdmin running in your workspace. Click to open."
  share        = "owner"
  subdomain    = false
  open_in      = "tab"
}

resource "coder_app" "phpldapadmin-app" {
  agent_id     = coder_agent.main.id
  slug         = "phpldapadmin-app"
  display_name = "phpLDAPadmin"
  icon         = "${data.coder_workspace.me.access_url}/icon/php.svg"
  url          = "http://localhost:8081"
  tooltip      = "phpLDAPadmin running in your workspace. Click to open."
  share        = "owner"
  subdomain    = false
  open_in      = "tab"
}